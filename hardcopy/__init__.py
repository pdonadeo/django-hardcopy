...
def file_to_png(input_file, output_file, width, height, **extra_args):
    """
    Given an input file(HTML) and an output file, render the HTML as a PNG and save it to output_file
    input_file and output_file are both (open) file-like objects.
    :param html_data:  file like object to read from
    :param output_file: file like object to write to
...
def bytestring_to_png(html_data, output_file, width, height, **extra_args):
    """
    Given a bytestring of html data as input (like a rendered django template response), render a PNG
    and write the output to output_file
    :param html_data:  bytestring of html data
    :param output_file: file like object to write to
    :param width: width of the viewport in pixels
